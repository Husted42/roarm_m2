...
list_commands = [
    ...
    # Move arm down under table
    {"T":102,"base":math.pi,"shoulder":0,"elbow": math.pi/2,"hand":math.pi,"spd":0,"acc":10},
    {"T":102,"base":math.pi,"shoulder":math.pi/2,"elbow": math.pi/2,"hand":math.pi,"spd":0,"acc":10},
]
